System.register(['angular2/core', './courses.service', './autogrow.directive'], function(exports_1, context_1) {
    "use strict";
    ...
    return {
        ...
        execute: function() {
            CoursesComponent = (function () {
                function CoursesComponent(courseServices) {
                ...
                CoursesComponent = __decorate([
                    core_1.Component({
                        ...
                        providers: [courses_service_1.CourseServices],
                        directives: [autogrow_directive_1.AutoGrowDirective]
                    }), 
                    __metadata('design:paramtypes', [courses_service_1.CourseServices])
                ], CoursesComponent);
